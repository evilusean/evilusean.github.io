...
## Overview
A client-side static web application designed to compute solar positioning and project passive solar heat gain/sunlight duration for property planning, based on permaculture design principles 
...
2.  **Overhang/Tree Simulation:** Calculate the necessary overhang size to block high-angle summer sun while allowing low-angle winter sun
...
* `/assets/js/solar-engine.js` - Logic for seasonal sun pathing 
